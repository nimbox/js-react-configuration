...
export const ConfigurationBaseProperty: FC<ConfigurationBasePropertyProps> = ({ property, children }) => {
    ...
    return (
        <div className="bg-gray-300 p-2.5 w-6/12 m-1">
            ...
            <div className='flex justify-start p-1.5'>
                ...
                { showDropdown ? (<div className="origin-top-right absolute mt-10 ml-16 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex={-1} onBlur={handleBlur} onFocus={handleFocus}>
